	...
	@section('CustomJs')
		...
		/* ------------------------------------------------------------------------------- */
			...
			$("#add-additional").click(function (e) {
				...
				html += "<div class='col-md-6'><input type='number' class='form-control monto_formato_decimales' onkeydown='noPuntoComa( event )' name='price_aditional[]' placeholder='Precio del adicional'></div>"
				html += "<br><br>"
			...
			$("#add-additional_edit").click(function (e) {
				...
				html += "<div class='col-md-2'></div>"
				html += "<div class='col-md-6'><input type='text' class='form-control' name='aditional[]' placeholder='Descripcion del adicional'></div>"
				html += "<div class='col-md-4'><input type='number' class='form-control monto_formato_decimales' onkeydown='noPuntoComa( event )' name='price_aditional[]' placeholder='Precio del adicional'></div>"
				html += "<br><br>"
