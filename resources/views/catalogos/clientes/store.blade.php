                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_nacimiento" class="form-control form-control-user" id="fecha_nacimiento" placeholder="PJ. Cardenas" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="number" name="number_children" class="form-control form-control-user" disabled id="number_children" placeholder="PJ. 1">
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="previous_surgery" class="form-control form-control-user" disabled id="previous_surgery" placeholder="PJ. Mamaria">
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="major_disease" class="form-control form-control-user" disabled id="major_disease" placeholder="PJ. Asma">
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="drink_medication" class="form-control form-control-user" disabled id="drink_medication" placeholder="PJ. Asma">
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="allergic_medication" class="form-control form-control-user" disabled id="allergic_medication" placeholder="PJ. Acetaminofen" >
                                </div>
