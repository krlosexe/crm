...
>>>>>>> d7057d5c1881345e678265784e54c1e5357ec732
...
<<<<<<< HEAD
                ...
                <br>
                    ...
                    <div class="form-group valid-required">
                        <input type="text" class="form-control form-control-user" name="valorp" id="valorp_edit">
                    </div>
                </div>
                ...
                <br>
                    ...
                    <div class="form-group valid-required">
                        <input type="text" class="form-control form-control-user" name="resultadop" id="resultadop_edit">
                    </div>
                </div>
                    ...
                    <br>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="form-group valid-required">
                                    <input type="text" class="form-control form-control-user" name="nomser" id="nomser_edit">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="form-group valid-required">
                                    <input type="text" class="form-control form-control-user" name="obser" id="obser_edit">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <label for=""><b>CANTIDAD</b></label>
                                <div class="form-group valid-required">
                                    <input type="text" class="form-control form-control-user" name="cantidadser" id="cantidadser_edit">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <label for=""><b>FECHA CREACIÓN</b></label>
                                <div class="form-group valid-required">
                                    <input type="date" class="form-control form-control-user" name="fechaser" id="fechaser_edit">
                                </div>
                            </div>
